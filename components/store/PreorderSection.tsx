...
export function PreorderSection({ preorderProducts }: PreorderSectionProps) {
  ...
  return (
    <section className="py-16 md:py-24 bg-[#2B2118] text-[#FAF6F2] overflow-hidden relative border-b border-[#3E3025]">
      {/* Background Decorative glow */}
      <div className="absolute top-1/2 -left-48 w-96 h-96 bg-[#B76E79]/20 rounded-full blur-3xl pointer-events-none" />
