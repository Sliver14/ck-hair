    ...
    <section className="py-16 md:py-20 bg-[#2B2118] text-[#FAF6F2] border-b border-[#3E3025]">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6">
        ...
        <p className="text-xs md:text-sm text-[#D8C7B8] max-w-md mx-auto font-light">
          Be the first to access limited single-donor hair drops, private trunk shows, and exclusive styling perks across Nigeria.
        </p>
        ...
        {isSuccess ? (
          ...
          >
            ...
            >
              <span>{isSubmitting ? "Enrolling..." : "Join VIP List"}</span>
